...
object Def {
    ...
    val EXCHANGE_VALUE = 100
    val EXCHANGE_TIME = 10
    val HOUSE_LIMIT = 6
    val HOUSE_PLUS_LIMIT = 3
    val FARM_LIMIT = 100
    val FARM_PLUS_LIMIT = 50
    val FACTORY_LIMIT = 100
    val FACTORY_PLUS_LIMIT = 50
    val SCHOOL_LIMIT = 4
    val SCHOOL_CITIZEN_COST = 75
    val WAREHOUSE_LIMIT = 200
